...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      >
        <p className={styles.sectionSubText}>Des informations de vous</p>
        ...
        >
          ...
          <label className='flex flex-col'>
            ...
            <input
              ...
              value={form.email}
              onChange={handleChange}
              placeholder="Quelle est votre addresse email ?"
              className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium'
            />
          </label>
          <label className='flex flex-col'>
            ...
            <textarea
              ...
              value={form.message}
              onChange={handleChange}
              placeholder='Quelle est votre impression par rapport a ce portfolio ?'
              className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium'
            />
          </label>
